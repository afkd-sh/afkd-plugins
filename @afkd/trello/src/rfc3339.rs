//! Dependency-free RFC-3339 / ISO-8601 decoding and encoding: the reader a Trello comment's
//! `dateLastEdited` and a card's `createCard` date go through, and the writer the `comments`
//! reply's `at` comes out of.
//!
...
///
/// Handles the forms a board or forge emits: `2026-06-27T12:34:56Z`, a numeric offset
...
mod tests {
    ...
    /// `at` with: the epoch (an undatable Trello comment id decodes to it), a leap day, the
