...
//! `on_done` / `on_fail` / `on_park` block is written in, and the parse that flattens
//! such a block — as afkd lowers it to JSON — into an ordered list of them. Ported from
//! afkd's `afkd_forge::lifecycle`, with one difference the wire forces.
//!
