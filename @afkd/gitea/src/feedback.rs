//! The **feedback decision** and the brief's **feedback section**. Ported from afkd's
...
//! The section renderer is shared with the issue kind, whose re-claimed issue carries the
//! human replies back to the agent the same way, each attributed to its author.
