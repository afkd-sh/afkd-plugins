...
//! suites cannot come to disagree about what GitLab does.
//!
//! ## No hangs on failure
//!
...
#[path = "../../../../../@afkd/gitlab/tests/common/fake.rs"]
pub mod fake;
...
/// from the `target/release/afkd-gitlab` its `exec` names. `RUSTUP_HOME` and `CARGO_HOME`
